...
class FilteredPlayerSerializer(serializers.Serializer):
    """Serializer for filtered player list items with prediction info."""
    ...
    will_be_superstar = serializers.BooleanField()
    superstar_label = serializers.CharField()
...
class PredictionRequestSerializer(serializers.Serializer):
    ...
    attacking_heading_accuracy = serializers.IntegerField(
    ...
    defending_standing_tackle = serializers.IntegerField(
        required=False, allow_null=True
    )
